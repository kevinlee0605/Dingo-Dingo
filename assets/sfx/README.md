...
Fishing sounds used by `src/shared/FishingSFX.luau`.

The cast and bobber audio are combined into the Toolbox `FishingCast` sound and
play once when the player casts:
...
| `reveal_epic.wav` | `107836963921337` |
| `reveal_legendary.wav` | `93961696300593` |
| `reveal_mythic.wav` | `110938581306711` |

Regenerate the WAV sources with `tools/generate_fishing_sfx.py`.
